...
<div class="dashboard-page">
    ...
    {{-- =========================================================
         MAPA DE VENDEDORES DESPLEGABLE
    ========================================================== --}}
    <div class="map-card">
        ...
        <div class="map-header">
            ...
            <div>
                <h2>Ubicación de vendedores</h2>

                <p>
                    Última ubicación registrada durante la jornada de hoy.
                </p>
            </div>
            ...
            <div class="map-actions">
                ...
                <div class="map-total">
                    ...
                    {{ $mapaVendedores->count() }}

                    {{ $mapaVendedores->count() === 1
                        ? 'ubicación'
                        : 'ubicaciones'
                    }}
        ...
        >
            ...
            @else
                ...
                <div class="map-empty">
                    ...
                    No existen vendedores con coordenadas disponibles
                    para mostrar en el mapa de hoy.
