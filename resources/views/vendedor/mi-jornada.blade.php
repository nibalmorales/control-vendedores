...
\n\n/*\n|--------------------------------------------------------------------------\n| SEGUIMIENTO DE UBICACIÓN DEL SUPERVISOR\n|--------------------------------------------------------------------------\n*/\n\n@if($esSupervisor && $asistencia && !$asistencia->hora_salida)\n\nlet seguimientoSupervisorActivo = true;\nlet ultimaPosicionEnviada = null;\nlet ultimoEnvioUbicacion = 0;\n\nfunction enviarUbicacionSupervisor(position)\n{\n    if (!seguimientoSupervisorActivo) {\n        return;\n    }\n\n    const latitud = position.coords.latitude;\n    const longitud = position.coords.longitude;\n    const precision = position.coords.accuracy;\n    const ahora = Date.now();\n\n    if (precision > 300) {\n        return;\n    }\n\n    if (ultimoEnvioUbicacion && (ahora - ultimoEnvioUbicacion) < 60000) {\n        return;\n    }\n\n    if (\n        ultimaPosicionEnviada &&\n        Math.abs(ultimaPosicionEnviada.latitud - latitud) < 0.000001 &&\n        Math.abs(ultimaPosicionEnviada.longitud - longitud) < 0.000001 &&\n        (ahora - ultimoEnvioUbicacion) < 120000\n    ) {\n        return;\n    }\n\n    ultimaPosicionEnviada = {\n        latitud: latitud,\n        longitud: longitud\n    };\n\n    ultimoEnvioUbicacion = ahora;\n\n    fetch(\n        '{{ route("supervisor.ubicacion.actualizar") }}',\n        {\n            method: 'POST',\n            headers: {\n                'Content-Type': 'application/json',\n                'Accept': 'application/json',\n                'X-CSRF-TOKEN': '{{ csrf_token() }}'\n            },\n            body: JSON.stringify({\n                latitud: latitud,\n                longitud: longitud,\n                precision: precision\n            })\n        }\n    )\n    .then(function(response) {\n        if (!response.ok) {\n            return response.json().catch(function() { return {}; }).then(function(data) { throw data; });\n        }\n        return response.json();\n    })\n    .catch(function(error) {\n        console.log('No se pudo actualizar la ubicación del supervisor.', error);\n    });\n}\n\nlet idSeguimientoSupervisor = null;\n\nif (navigator.geolocation) {\n    idSeguimientoSupervisor = navigator.geolocation.watchPosition(\n        enviarUbicacionSupervisor,\n        function(error) {\n            console.log('GPS supervisor:', error.message);\n        },\n        {\n            enableHighAccuracy: true,\n            maximumAge: 30000,\n            timeout: 30000\n        }\n    );\n}\n\nwindow.addEventListener('beforeunload', function () {\n    seguimientoSupervisorActivo = false;\n\n    if (idSeguimientoSupervisor !== null && navigator.geolocation) {\n        navigator.geolocation.clearWatch(idSeguimientoSupervisor);\n    }\n});\n\n@endif\n
</script>
